...
class Gearlever_Modded : public Gearlever {
	...
	public:
		...
		VaLas_Controller::ShiftRequest GetShiftRequest(VaLas_Controller::GearLeverPosition* currentLeverPositionPtr, VaLas_Controller::ShiftRequest* currentShiftRequestPtr);
